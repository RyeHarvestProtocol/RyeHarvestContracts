...
contract WinnerAddresses is FomoTimer {
    event AnnounceWinners(uint256 roundId, uint256 firstIndex, address[] rewardWinners, uint256 winnersLength);
    ...
    function getWinnerAddrs(uint256 _rID) public view returns (address[] memory winnerAddrs) {
    ...
    function getNextWinderIndex(uint256 _winderAddrIndex, uint256 _rID) private view returns (uint256) {
