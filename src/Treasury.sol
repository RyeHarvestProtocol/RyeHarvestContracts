...
contract HydraTreasury {
    ...
    function getNumWhitelist() external view returns (uint256 numWhitelistedCoins_) {
        numWhitelistedCoins_ = numWhitelistedCoins;
    }

    function getTokenValue(address _token, uint256 _amount) public pure returns (uint256) {
        return _amount;
    }
